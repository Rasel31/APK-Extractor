...
file_path = "D:\\Androguard\\androguard-master\\Class-encryption-permission-pattern.csv"
...
# plt.title('0 to 50 of 152 CLASS ENC. Permissions')
# plt.title('51 to 100 of 152 CLASS ENC. Permissions')
plt.title('101 to Last of 152 CLASS ENC. Permissions')
...
# with open('class-enc-permission.txt', 'w', encoding='utf-8') as f:
#     count = 1
