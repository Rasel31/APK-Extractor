...
file_path = "D:\\Androguard\\androguard-master\\trivial+string-encryption-permission-pattern.csv"
...
# plt.title('0 to 50 of 115 TRIVIAL+STRING ENC. Permissions')
# plt.title('51 to 100 of 115 TRIVIAL+STRING ENC. Permissions')
plt.title('101 to Last of 115 TRIVIAL+STRING ENC. Permissions')
...
# with open('trivial+string-enc-permission.txt', 'w', encoding='utf-8') as f:
#     count = 1
