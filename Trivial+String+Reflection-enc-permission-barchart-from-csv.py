...
file_path = "D:\\Androguard\\androguard-master\\TRIVIAL+STRING_ENCRYTPION+REFLECTION_APK-encryption-permission" \
            "-pattern.csv "
...
# plt.title('0 to 50 of 111 TRIVIAL+STRING+REFLECTION ENC. Permissions')
# plt.title('51 to 100 of 111 TRIVIAL+STRING+REFLECTION ENC. Permissions')
plt.title('101 to Last of 111 TRIVIAL+STRING+REFLECTION ENC. Permissions')
...
# with open('trivial+string+reflection-enc-permission.txt', 'w', encoding='utf-8') as f:
#     count = 1
