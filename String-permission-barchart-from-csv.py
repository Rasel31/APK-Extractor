...
file_path = "D:\\Androguard\\androguard-master\\string-encryption-permission-pattern.csv"
...
# plt.title('0 to 50 of 152 String ENC. Permissions')
# plt.title('51 to 100 of 152 String ENC. Permissions')
plt.title('101 to Last of 152 String ENC. Permissions')
...
# with open('string-enc-permission.txt', 'w', encoding='utf-8') as f:
#     count = 1
