...
parrent_folder = "D:\\Progaurd Dataset\\TRIVIAL+STRING_ENCRYTPION+REFLECTION_APK"
...
with open('TRIVIAL+STRING_ENCRYTPION+REFLECTION_APK-encryption-permission-pattern.csv', mode='w') as csv_pattern:
